...
useEffect(() => {
  ...
  const dataPh = {
    labels: valList.map((value:any)=>(value.date)).reverse(),
    datasets: [{
      label: 'pH Values',
      //data: valList.map((value:any)=>(value.phValues)),
      data: valList.map((value:any)=>(value.phValues)).reverse(),
      //data:[6.5,8.9,2.3],
      fill: false,
  ...
  const dataEc = {
    ...
    datasets: [{
      label: 'EC Values',
      data: valList.map((value:any)=>(value.ecValues)).reverse(),
      //data:[6.5,8.9,2.3],
      fill: false,
      borderColor: 'rgb(75, 192, 192)',
      tension: 0.1
  ...
  const dataTemp = {
    ...
    datasets: [{
      ...
      data: valList.map((value:any)=>(value.tempValues)).reverse(),
      //data:temp,
      //data:[6.5,8.9,2.3],
      fill: false,
      borderColor: 'rgb(75, 192, 192)',
